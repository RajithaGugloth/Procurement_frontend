...
public class RequisitionMapper {
    ...
    public static Requisition toEntity(
        ...
        if (dto.getRequisitionNumber() != null && !dto.getRequisitionNumber().equalsIgnoreCase("null")) {
    ...
    public static RequisitionRequestDTO toDTO(Requisition requisition) {
        ...
        if (requisition.getVendor() != null) {
            dto.setVendorId(requisition.getVendor().getId());
        }
